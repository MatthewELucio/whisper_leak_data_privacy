...
class AmazonNovaProV1OpenRouter(ChatbotBase):
    """
        Amazon Nova Pro V1 chatbot using OpenRouter API.
    """
    _common_name = 'nova-pro-v1 (OpenRouter)'
    ...
    def send_prompt(self, prompt, temperature):
        ...
        stream = self._client.chat.completions.create(
            model="amazon/nova-pro-v1",  # Use the correct model ID
            messages=[
